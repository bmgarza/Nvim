...
vim.opt.virtualedit = "block,onemore" -- Allow going past end of line in visual block mode like in VSCode.
...
vim.opt.colorcolumn = "121" -- PEP8 like character limit vertical bar.
